                            ...
                            <div className={'col-md-12 p-0 '}>
                                <ul>
                                    <li className={'list-unstyled'}>
                                        <Link  onClick={openModal} to={"/Driver/Dashboard"}><img src={"https://app.scargos.com/images/driver-icon-active.svg"}
                                                                     className={'img-fluid rounded-circle'}/>Haydovchi</Link>
                                    </li>
                                    <li className={'list-unstyled'}>
                                        <Link to={"/Driver/buyurtmalar"}>Joriy</Link>
                                    </li>
                                    <li className={'list-unstyled'}>
                                        <Link to={"/Driver/qidirish"}> Mening buyurtmalarim</Link>
                                    </li>
                                    <li className={'list-unstyled'}>
                                        <Link to={"/Driver/transport"}>Transport</Link>
                                    </li>
                                    <li className={'list-unstyled'}>
                                        <Link to={"/Driver/sozlamalar"}>Sozlamalar</Link>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div className={'row'}>
                            <div style={{width: "100%", marginTop: "34px"}}>
                                <Switch>
                                    ...
                                    <Route exact path="/Driver/buyurtmalar">
                                        <Buyurtmalar/>
                                    </Route>
                                    <Route path="/Driver/qidirish">
                                        <BuyurtmaQidirish/>
                                    </Route>
                                    <Route path="/Driver/transport">
                                        <TransportPart/>
                                    </Route>
                                    <Route path="/Driver/sozlamalar">
                                        <Sozlamalar/>
                                    </Route>
                                </Switch>
                            </div>
